export const baseInputClass =
  "w-full border-[0.0001px] border-gray-600 rounded outline-none " +
  "text-sm sm:text-base p-2 sm:p-1.5 " +
  "focus:outline-none focus:border-primaryLight focus:border-[0.5px] " +
